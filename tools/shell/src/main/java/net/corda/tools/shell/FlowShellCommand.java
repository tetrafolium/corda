...
public class FlowShellCommand extends InteractiveShellCommand {
    ...
    public void start(
            final @Usage("The class name of the flow to run, or an unambiguous substring") @Argument String name,
    ...
    public void watch(final InvocationContext<TableElement> context) throws Exception {
        runStateMachinesView(out, ops());
    }

    static void startFlow(final @Usage("The class name of the flow to run, or an unambiguous substring") @Argument String name,
                          final @Usage("The data to pass as input") @Argument(unquote = false) List<String> input,
                          final RenderPrintWriter out,
                          final CordaRPCOps rpcOps,
                          final ANSIProgressRenderer ansiProgressRenderer,
    ...
    public void list(final InvocationContext<String> context) throws Exception {
